package es.urjc.ia.bikesurbanfleets.core.config.deserializers;

import com.google.gson.*;
import es.urjc.ia.bikesurbanfleets.core.config.entrypoints.EntryPoint;
import es.urjc.ia.bikesurbanfleets.core.config.entrypoints.EntryPointFactory;
import es.urjc.ia.bikesurbanfleets.core.config.entrypoints.distributions.Distribution;
