...
![It shows the architecture of the software. It shows two clear parts: backend and frontend](IAgroup/documentation/images/Arquitecture_6.png?raw=true "Software arquitecture")
