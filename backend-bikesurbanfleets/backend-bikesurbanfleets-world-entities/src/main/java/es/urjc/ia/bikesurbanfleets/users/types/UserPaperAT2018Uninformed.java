 ...
 *
 */
@UserType("USER_PAPERAT2018_UNINF")
public class UserPaperAT2018Uninformed extends User {
    ...
    public UserPaperAT2018Uninformed(JsonObject userdef, SimulationServices services, long seed) throws Exception{
