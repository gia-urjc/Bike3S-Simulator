...
public class SimulationServices {
    ...
    public SimulationServices(GlobalInfo globalInfo, List<Station> stations)
        ...
        this.infrastructureManager = new InfraestructureManager(stations, globalInfo.getBoundingBox());
        this.graphManager = initGraphManager(globalInfo.getGraphManagerType(), globalInfo.getGraphParameters());
