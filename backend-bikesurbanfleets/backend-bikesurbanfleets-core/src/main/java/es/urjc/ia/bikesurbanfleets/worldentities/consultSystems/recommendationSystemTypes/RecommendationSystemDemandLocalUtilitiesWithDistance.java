 ...
 *
 */
@RecommendationSystemType("LOCAL_UTILITY_W_DISTANCE_DEMAND")
public class RecommendationSystemDemandLocalUtilitiesWithDistance extends RecommendationSystem {
    ...
    public RecommendationSystemDemandLocalUtilitiesWithDistance(JsonObject recomenderdef, InfraestructureManager infraestructureManager) throws Exception {
