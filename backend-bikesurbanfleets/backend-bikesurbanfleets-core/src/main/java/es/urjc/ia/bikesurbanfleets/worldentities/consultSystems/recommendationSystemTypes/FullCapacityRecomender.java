...
public class FullCapacityRecomender extends RecommendationSystem {
    ...
    public FullCapacityRecomender(JsonObject recomenderdef, SimulationServices ss) throws Exception {
        super(ss);
        //***********Parameter treatment*****************************
