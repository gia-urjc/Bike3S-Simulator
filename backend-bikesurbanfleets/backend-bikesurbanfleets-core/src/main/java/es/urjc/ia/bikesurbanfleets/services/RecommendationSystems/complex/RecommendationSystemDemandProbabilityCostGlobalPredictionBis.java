...
public class RecommendationSystemDemandProbabilityCostGlobalPredictionBis extends RecommendationSystemDemandProbabilityBased {
    ...
    public RecommendationSystemDemandProbabilityCostGlobalPredictionBis(JsonObject recomenderdef, SimulationServices ss) throws Exception {
