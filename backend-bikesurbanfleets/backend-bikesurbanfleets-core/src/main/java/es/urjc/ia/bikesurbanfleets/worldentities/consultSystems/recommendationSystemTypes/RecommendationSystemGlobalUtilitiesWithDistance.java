...
public class RecommendationSystemGlobalUtilitiesWithDistance extends RecommendationSystem {
    ...
    public RecommendationSystemGlobalUtilitiesWithDistance(JsonObject recomenderdef, InfraestructureManager infraestructureManager) throws Exception {
...
//            double utility=1- Math.abs(s.availableBikes()- idealAvailable)/idealAvailable;
            ...
            double normedUtilityDiff=(newutility-utility)*((double)s.getCapacity()/(double)infraestructureManager.getMaxStationCapacity());
     ...
     /*       double maxcap=(double)infraestructureManager.getMaxStationCapacity();
            double maxinc=(4D*(maxcap-1))/Math.pow(maxcap,2);
