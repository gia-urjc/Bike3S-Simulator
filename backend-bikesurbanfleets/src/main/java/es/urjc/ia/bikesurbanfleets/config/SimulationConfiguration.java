...
import es.urjc.ia.bikesurbanfleets.config.deserializers.EntryPointDeserializer;
import es.urjc.ia.bikesurbanfleets.config.deserializers.StationDeserializer;
