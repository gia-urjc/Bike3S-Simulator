package es.urjc.ia.bikesurbanfleets.config.deserializers;

import com.google.gson.*;
import es.urjc.ia.bikesurbanfleets.config.entrypoints.EntryPoint;
import es.urjc.ia.bikesurbanfleets.config.entrypoints.EntryPointFactory;
import es.urjc.ia.bikesurbanfleets.config.entrypoints.distributions.Distribution.DistributionType;
