...
export class ReservationsInfo implements Info {
    ...
    public increaseSuccessfulBikeReservations(key: number): void {
        let value: number = this.successfulBikeReservations.value.get(key);        
        if (value !== undefined) {
    ...
    public increaseFailedBikeReservations(key: number): void {
        let value: number = this.failedBikeReservations.value.get(key);        
        if (value !== undefined) {
    ...
    public increaseSuccessfulSlotReservations(key: number): void {
        let value: number = this.successfulSlotReservations.value.get(key);        
        if (value !== undefined) {
    ...
    public increaseFailedSlotReservations(key: number): void {
        let value: number = this.failedSlotReservations.value.get(key);        
        if (value !== undefined) {
